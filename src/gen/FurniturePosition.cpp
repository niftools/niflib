...
//Constructor
FurniturePosition::FurniturePosition() : orientation((unsigned short)0), positionRef1((byte)0), positionRef2((byte)0), unknownShort1((unsigned short)0), unknownShort2((unsigned short)0) {};

...
//Constructor
TexDesc::TexDesc() : source(NULL), clampMode((TexClampMode)WRAP_S_WRAP_T), filterMode((TexFilterMode)FILTER_TRILERP), flags((unsigned short)0), uvSet((unsigned int)0), ps2L((short)0), ps2K((short)-75), unknown1((unsigned short)0), hasTextureTransform(false), tiling(1.0, 1.0), wRotation(0.0f), transformType_((unsigned int)0) {};
